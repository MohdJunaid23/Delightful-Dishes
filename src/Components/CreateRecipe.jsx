  ...
  return (
      <div>
          ...
          <form onSubmit={submitHandler} className='flex flex-col gap-4' action="">
              ...
              <textarea onChange={(e)=>setDescription(e.target.value)} value={description} className='textarea overflow-hidden max-h-fit mt-4 hover:shadow-black transition ease-in-out w-[38vw] border-none outline-none rounded text-lg px-2 py-4 bg-transparent shadow-lg shadow-white text-white placeholder:text-white'placeholder='Your recipe description here!'  />
